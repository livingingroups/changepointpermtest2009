...
set.seed(2025L)
cpt <- change_point_test_xyt(easting = path_trackframe[, "easting"],
...
ggplot() + geom_path(data = tf3[order(time(tf3)),],
...
ggplot() + geom_path(data = tf4[order(time(tf4)),],
...
```{r, out.width="100%"}
ggplot() + geom_path(data = tf7[order(time(tf7)),],
